...
async def status_task():
    while True:
        ...
        await asyncio.sleep(5)
        await client.change_presence(game=discord.Game(name='in S-ReQue Server'))
        await asyncio.sleep(5)
...
async def help(ctx):
    ...
    embed.add_field(name = '``Our Help Server Link`` ',value ='https://discord.gg/8u7zhm',inline = False)
